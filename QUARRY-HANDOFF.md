...
| Beam SIFF (`siff`) | `beam.siff` | `formats/siff.ksy`; `formats/siff.fields.json` | `samples/_staged/siff/INTRO_B.VB`; `samples/SOURCES.md` | third-party | width, height, num_frames, fps, audio_sample_rate, audio_channels, audio_bit_rate, video_codec, audio_codec | None | SIFF/VBV1/VBHD (320×240 @ 12; pcm_u8 22050/1) | Not implemented |
| Bethesda VID (`bethsoftvid`) | `bethesda.vid` | `formats/bethsoftvid.ksy`; `formats/bethsoftvid.fields.json` | `samples/_staged/bethsoftvid/ANIM0001.VID`; `samples/SOURCES.md` | third-party | width, height, audio_sample_rate, audio_channels, audio_bit_rate, video_codec, audio_codec | None | VID header plus first-audio DAC time constant (320×200; audio is stream 0) | Not implemented |
...
| Delphine CIN (`dsicin`) | `delphine.cin` | `formats/dsicin.ksy`; `formats/dsicin.fields.json` | `samples/_staged/dsicin/LOGO-partial.CIN`; `samples/SOURCES.md` | third-party | width, height, fps, audio_sample_rate, audio_channels, audio_bit_rate, video_codec, audio_codec | None | 0x55AA0000 header (320×160 @ 12; dsicinaudio 22050/1; not idcin) | Not implemented |
...
| Nintendo BFSTM (`bfstm`) | `nintendo.bfstm` | `formats/bfstm.ksy`; `formats/bfstm.fields.json` | `samples/_staged/bfstm/spl-forest-day.bfstm`; `samples/SOURCES.md` | third-party | sample_rate, channels, num_samples, loop_start, audio_codec | None | FSTM/INFO (codec 2 THP, 32000/1, loop start µs; not BRSTM) | Not implemented |
...
| Maxis XA (`xa`) | `maxis.xa` | `formats/xa.ksy`; `formats/xa.fields.json` | `samples/_staged/xa/SC2KBUG.XA`; `samples/SOURCES.md` | third-party | sample_rate, channels, bit_rate, audio_codec | None | XAJ header (adpcm_ea_maxis_xa 22050/2; not ADX) | Not implemented |
