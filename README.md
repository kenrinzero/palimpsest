...
Palimpsest is active on a Tier 6 expansion. Eighteen specs are
differential-GREEN. Wave A is complete. Next: Wave B FATE staging.
See `BACKLOG.md`.
...
`ast`, `argo_asf`, `alp`, `apm`, `kvag`, `smjpeg`.
